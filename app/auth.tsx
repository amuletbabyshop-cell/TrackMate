    ...
    <View style={styles.bg}>
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <Animated.View style={[styles.content, { opacity: contentOpac, transform: [{ translateY: contentY }] }]}>
          ...
          <Text style={styles.desc}>アカウントでデータを安全に保存</Text>
...
const styles = StyleSheet.create({
  ...
  logoArea: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 16 },
  ...
  desc: { color: TEXT.secondary, fontSize: 14, textAlign: 'center' },
  ...
  gText: { fontSize: 13, fontWeight: '900', color: '#fff' },
  ...
  guestNote: { color: TEXT.hint, fontSize: 11, marginTop: 2 },
